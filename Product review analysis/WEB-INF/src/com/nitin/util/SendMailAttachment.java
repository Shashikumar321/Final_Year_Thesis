...
public class SendMailAttachment {
	...
	{
		boolean debug = true;
		String from="dhsinfoblr@gmail.com";
		try
		{
			...
			Session session = Session.getInstance(props,	new javax.mail.Authenticator() 
			{
				...
				{
					return new PasswordAuthentication("dhsinfoblr", "dhsbangalore");
				}
			});
	...
	public static void main(String args[]) throws MessagingException, Exception
	{
		...
		to[0]="mpkumarcse@gmail.com";
		to[1]="mpkumarcse@hotmail.com";
		to[2]="mpkumarcse@gmail.com";
