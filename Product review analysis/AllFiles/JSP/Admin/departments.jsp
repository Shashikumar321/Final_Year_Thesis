...
<p>
	...
	<table border="1"  id="results"  cellpadding="5px" cellspacing="1px" width="500px">
		...
		<tr>
			...
			<font color="maroon" style="font-style: bold;font-family: monotype corsiva" size="6">Domain Details</font>
			</td>
		...
		<tr>
			<th><font color="blue" size="" style="font-family: cursive;">Domain ID</font></th>
			<th><font color="blue" size="" style="font-family: cursive;">Domain Name</font></th>
		</tr>
