...
<p>
	...
	<table border="1"  id="results" cellpadding="5px" cellspacing="1px" width="660px">
		...
		<tr>
			...
			<font color="maroon" style="font-style: bold;font-family: monotype corsiva" size="6">SubDomain Details</font>
			</td>
		...
		<tr>
			<th><font color="blue" size="" style="font-family: cursive;">SubDomain ID</font></th>
			<th><font color="blue" size="" style="font-family: cursive;">SubDomain Name</font></th>
		</tr>
