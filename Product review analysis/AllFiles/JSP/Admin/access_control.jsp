				...
				<form name="f1" action="<%=request.getContextPath()%>/ControlFileAcess" method="post">
					...
					<tr>
							<td colspan="7" align="center">
								<font color="maroon" style="font-style: bold;font-family: Monotype corsiva;" size="6">
								File Access Control</font>
							</td>
					</tr>
					...
					<tr align="center">
							<td width="100px"><font color="blue" size="4">File</font> </td>
							<td width="75px">:</td>
							<td width="200px">
								<select name="file" class="field2" required="yes">
					...
					<tr align="center">
							<td width="100px"><font color="blue" size="4">Domain</td>
							<td width="75px">:</td>
							<td width="200px">
								<select name="dept" class="field2" required="yes">
								    	<option value="0">--Select--</option>
								    	<%
					...
					<tr align="center">
							<td width="100px"><font color="blue" size="4">SubDomain</td>
							<td width="75px">:</td>
							<td width="200px">
								<select name="designation" class="field2" required="yes">
								    	<option value="0">--Select--</option>
